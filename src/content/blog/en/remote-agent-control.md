...
The setup requires three components: a VPS running your AI agent, the bridge service, and a bot on your messaging platform. If you are already self-hosting agents (see our [VPS setup guide](/en/self-hosting-ai-agents)), adding the bridge is a single service in your Docker Compose stack.
